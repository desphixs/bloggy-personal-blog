...
SECRET_KEY = 'django-insecure-rj+!i_57p&98kn%pb6l)wb^qm*wq!vdw27pp+eb=x2ue2a6n6_'
...
INSTALLED_APPS = [
    ...
    # -------------------------------------------------------------------------
    # REGISTERING OUR CUSTOM APP: 'blog'
    # -------------------------------------------------------------------------
    ...
    #
    # However, you just built a brand new recreational gaming lounge (our 'blog' app)
    ...
    #
    # By adding the string 'blog' to this list, we are telling Django's central 
    # settings: "Hey Django, please look inside the 'blog' folder we created, load 
